@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('LaBank Solutions')])
                    ...
                    <div class="card-body ">
                        ...
                        <div class="bmd-form-group{{ $errors->has('tipoDocumento') ? ' has-danger' : '' }} mt-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="tipoDocumento" class="form-control" placeholder="{{ __('Tipo De Documento') }}"
                                    value="{{ old('tipoDocumento') }}" required autocomplete="tipoDocumento">
                            </div>
                        ...
                        <div class="bmd-form-group{{ $errors->has('numDocumento') ? ' has-danger' : '' }} mt-3">
                            <div class="input-group">
                                ...
                                <input type="text" name="numDocumento" class="form-control" placeholder="{{ __('Numero de Documento') }}"
                                    value="{{ old('numDocumento') }}" required autocomplete="numDocumento">
                            </div>
